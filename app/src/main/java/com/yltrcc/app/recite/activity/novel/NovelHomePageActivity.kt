package com.yltrcc.app.recite.activity.novel
...
class NovelHomePageActivity : AppCompatActivity() {
    ...
    private fun initData() {
        ...
        //初始化 底部导航栏
        TabBarUtils().initNovelTabBar(ConstantUtils.INDEX_STUDY_HOME, this, ctx);
    ...
    private fun initToolBar() {
        ...
        statusBarHeight = HelpUtils.getStatusBarHeight(this@NovelHomePageActivity)
    }
                ...
                when (event.action) {
                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        if (!isSlip && !isLongClick) {
                            ...
                            val intent = Intent(this@NovelHomePageActivity, ChatActivity::class.java)
